import pytest # uses pytest-regressions
import pandas as pd

def test_thorpe_dissipation_rate_output():
...
def test_finestructure_dissipation_rate_output():
...
def test_idemix_dissipation_rate_output():
